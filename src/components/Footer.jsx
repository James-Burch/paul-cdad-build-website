  ...
  return (
    <footer className="bg-gray-900 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Professional construction and architectural design services.
              Transforming spaces with quality craftsmanship and attention to
              detail.
            </p>
          ...
          <div>
            ...
            <div className="mt-6">
              <h5 className="text-md font-medium mb-2">Business Hours</h5>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-gray-300">
                  Local Service Area
                  <br />
                  <span className="text-sm">Covering surrounding areas</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Paul Cdad Build. All rights reserved.
            </div>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 bg-primary-orange text-white p-3 rounded-full shadow-lg hover:bg-orange-600 transition-colors z-40"
